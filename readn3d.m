function [data,status] = readn3d(year,doy,hour)

DataPath1 = 'D:\data\kronos_raw_data\rpws_n3d\lesia.obspm.fr\kronos\data';
...
DataPath2 = strcat(DataPath1, filesep ,yearstr,'_',dirstr,filesep,'n3d');
filename = strcat('N3d_dsq',yearstr,doystr,'.',hourstr);
