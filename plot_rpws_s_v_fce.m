% Yang Yifei Sustech Shenzhen 2022-03-10
function [] = plot_rpws_s_v_fce(year,doy,hour,hd,freq1,freq2)
    ...
    xticks([]);
    % xticks([date2t97(year,month,day,8,46,00) date2t97(year,month,day,8,50,00)]);
    % xticklabels(["08:46","08:50"]);
    % yticks([7 7.5 8 8.5 9 9.5 10]);
    
    % xticks([date2t97(year,month,day,13,26,00) date2t97(year,month,day,13,33,00)]);
    % xticklabels(["13:26","13:33"]);
    
    % xticks([date2t97(year,month,day,15,07,00) date2t97(year,month,day,15,17,00)]);
    % xticklabels(["15:07","15:17"]);
